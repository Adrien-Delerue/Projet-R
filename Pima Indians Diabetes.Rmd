...
Under the columns, you can see the number of NA values that have been placed, which correspond to the number of errors/missinformation that existed before the operation.
